					...
					foreach ($lockerDetail as $data) { ?>
						<table id="example1" class="table table-bordered table-striped">
							...
							<tr>
								...
								<td><?php echo $data['CompleteAddress'] ?></td>
							</tr>
							<tr>
								<th>Occupation</th>
								<td><?php echo $data['Occupation'] ?></td>
								<th>Type of Locker</th>
								<td><?php echo $data['SizeofLocker'] ?></td>
							</tr>
							<tr>
								<th>Locker Number</th>
								<td><?php echo $data['LockerNumber'] ?></td>
								<th>Key Number</th>
								<td><?php echo $data['KeyNumber'] ?></td>
							</tr>
							<tr>
								<th>Instruction(if any)</th>
								<td><?php echo $data['Instructions'] ?></td>
								<th>Name of Nominee</th>
								<td><?php echo $data['NomineeName'] ?></td>
							</tr>
							<tr>
								<th>Relation with Nominee</th>
								<td><?php echo $data['Relationwithnominee'] ?></td>
								<th>Valuable Details</th>
								<td><?php echo $data['ValuableDetails'] ?></td>
							</tr>
							<tr>
								<th>ID Proof</th>
								<td><?php echo $data['IDcard'] ?></td>
								<th>View ID Proof</th>
								<td><a href="banker/addressproof/<?php echo $data['IDproof'] ?>" width="100" height="100" target="_blank"> <strong style="color: red">View</strong></a></td>
							</tr>
							<tr>
								<th>View Pic</th>
								<td><img src="banker/photo/<?php echo $data['Photo']; ?>" width="100" height="100" value="<?php echo $data['Photo']; ?>>"></td>
								<th>Status</th>
