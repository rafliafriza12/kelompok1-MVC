			...
			<div class="w3-agileits-about-grids">
				...
				<div class="col-md-7 agile-about-left">
					...
					<?php foreach ($aboutus as $data) : ?>
						...
						<p class="sub-p2"><?php echo $data['PageDescription']; ?></p>
					<?php endforeach; ?>
	...
	<div class="mail" id="contact">
		<div class="container">
				...
				<div class="col-md-6 col-sm-6 contact-left-w3ls">
					...
					<?php foreach ($contactus as $data) : ?>
						...
						<div class="call">
							...
							<div class="col-md-10 col-sm-10 col-xs-10 contact-text-agileinf0">
								<h4>Call us</h4>
								<p>+<?php echo $data['MobileNumber']; ?></p>
							</div>
							<div class="clearfix"></div>
						</div>
				</div>
			...
			<div class="col-md-6 col-sm-6 agileinfo_mail_grid_right">
				...
				<form name="bwdatesreportds" method="post
					...
					<br>
					<button type="submit" class="btn btn-primary" name="route" value="search-locker-details">Search</button>
				</form>
			</div>
			<div class="clearfix"> </div>
			</div>
