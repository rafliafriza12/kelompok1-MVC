...
<div class="about" id="about">
	<div class="container">
            ...
            <h1 align="center">Search Locker Details  againt keyword "<?php echo $searchinput;?>"</h1>
            <hr />
...
?>
    <tr>
        ...
        <?php } ?>
    	<td><?php echo $data['LockerAssigndate']?></td>
		<form action="">
			<th><button href="locker-detail?ltid=<?php echo $data['ID'];?>" class="btn btn-primary" name="route" value=""> View Details </button></th>
		</form>
    </tr>
        <?php $cnt++;
	endforeach;
